...
Bots=[mid]
admin=["u7a92b4c0c87a2dfeedec343276cea972"]
wait = {
    'contact':True,
    'autoJoin':True,
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Hi juga, apa kabar? 􀜁􀅔Har Har􏿿")

#-----------------------------------------------

            elif msg.text in ["Cv say kaneky"]:
                ki.sendText(msg.to,"iya ada apa? 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say bobo ah","Bobo dulu ah"]:
                ki.sendText(msg.to,"Have a nice dream Cv 􀜁􀅔Har Har􏿿")
            elif msg.text in ["#welcome"]:
                ki.sendText(msg.to,"Selamat datang di neraka😂")
